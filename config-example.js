...
_defaultContext = {
	...
	contactTemplate: JSON.stringify(_contactTemplate),
	linkTemplate: JSON.stringify(_linkTemplate),
	metadataTemplate: JSON.stringify(_metadataTemplate)
};
